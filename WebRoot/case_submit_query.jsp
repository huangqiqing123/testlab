...
<script type="text/javascript">
	...
	function reject() {
		...
		if (obj != null) {
			...
			document.form2.action = "casedo.do?method=reject";
			document.form2.submit();
		}
	}
	//执行查询
	function query() {
		...
		document.formQuery.action = "casedo.do?method=query&path=case_submit_query.jsp&pageSize="+pageSize;
...
<script language="javascript" src="js/pub.js"></script>
	...
	<tr>
	<td>
		<form name="formQuery" action="casedo.do?method=query&path=case_submit_query.jsp" method="post">
		<fieldset>
			<legend>查询条件</legend>		
			<%
			...
			<legend>
					...
					<tr>
						...
						<th id="upload_time" onclick="sort(this)" nowrap="nowrap" width="150"><a style="CURSOR:hand">上传时间<span id='upload_time_gif'></span></a></th>
			...
			<form name="public_info" action="casedo.do?method=query&path=case_submit_query.jsp" method="post" >
					<input type="hidden" name="sort" value=<%=query_condition.getSort()%>>
					<input type="hidden" name="sortType" value=<%=query_condition.getSortType()%>>
